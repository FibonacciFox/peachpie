...
namespace Peachpie.CodeAnalysis.Symbols
{
    ...
    internal static class ObsoleteAttributeHelpers
    {
        ...
        internal static ObsoleteAttributeData GetObsoleteDataFromMetadata(EntityHandle token, PEModuleSymbol containingModule, bool ignoreByRefLikeMarker)
        {
            ...
            obsoleteAttributeData = containingModule.Module.TryGetDeprecatedOrExperimentalOrObsoleteAttribute(token, new MetadataDecoder(containingModule), ignoreByRefLikeMarker, ignoreRequiredMemberMarker: false);
        ...
        //        {
        //            symbol = (Symbol)((MethodSymbol)symbol).AssociatedSymbol;
        //        }
